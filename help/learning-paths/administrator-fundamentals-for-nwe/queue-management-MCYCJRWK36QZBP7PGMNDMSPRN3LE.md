...
キュー管理 Workfront One 学習パスは、Experience League の[キュー管理](https://experienceleague.adobe.com/?recommended=Workfront-U-1-2022.1.request-queues){target="_blank"}コースに移行されました。
